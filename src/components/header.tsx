...
const Header = function Header() {
  ...
  return (
    <header className="fixed inset-0 z-20 mx-auto flex h-16 items-center justify-between rounded-lg bg-gray-800 px-4 text-white">
      <div className="flex items-center space-x-4"> {/* Flex container for image and text */}
        <Image src="/tt.png" alt="logo" width={40} height={40} className="w-10 h-10 object-contain" /> {/* Adjust size */}
